...
export class MembersPage implements OnInit {
  ...
  constructor(private filterService: FilterCardService, private userService: UserService, private router: Router) {}
  ...
  onClickToEditUser = (userId: string) => {
    this.router.navigate([`main/members/edit/${userId}`]);
  };
}
